...
public class PsiUpWrapper extends PsiUp {
	...
	private static final Logger log = LoggerFactory.getLogger(PsiUpWrapper.class);
	
	public PsiUpWrapper(PosNegLP learningProblem, AbstractReasonerComponent reasoningService) {
